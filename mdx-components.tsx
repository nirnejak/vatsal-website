      ...
      >
        <article
          className={classNames(
            ...
            "prose-tr:bg-neutral-200 prose-th:bg-neutral-300 dark:prose-tr:bg-neutral-800 dark:prose-th:bg-neutral-950/30 prose-td:py-2 prose-td:px-2.5 prose-th:py-2 prose-th:px-2.5 prose-table:rounded-xl",
