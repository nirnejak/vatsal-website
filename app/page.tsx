      ...
      <div className="mx-auto max-w-[580px] px-4 md:px-0">
        ...
        <div className="flex items-center justify-stretch gap-2">
          <a
            ...
            className="flex items-center gap-2.5 rounded-md bg-neutral-200 px-5 py-2.5 text-neutral-700 transition-colors hover:bg-neutral-300 dark:bg-neutral-800 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300"
            target="_blank"
          >
