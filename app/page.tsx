...
const HomePage: React.FC = () => {
  return (
    <main className="flex min-h-dvh items-center justify-center">
      <div
        className="
          mx-auto max-w-[580px] px-4
          md:px-0
        "
      >
        <h1
          className="
            text-4xl/snug font-semibold tracking-tight
            md:text-5xl
          "
        >
          <span
        ...
        <p
          className="
            mb-20 text-sm text-neutral-600
            md:text-base
          ...
          {SOCIAL_LINKS.map((link, i) => (
            <a
              ...
              className="
                ...
                bg-neutral-200 px-3.5 py-2 text-xs text-neutral-700
