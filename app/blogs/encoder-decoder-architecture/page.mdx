...
![Self-attention Diagram](/blog-images/encoder-decoder-architecture/banner.jpeg "Self-attention in NLP models")
...
![Encoder Decoder Diagram.png](/blog-images/encoder-decoder-architecture/Encoder_Decoder_Diagram.png)
