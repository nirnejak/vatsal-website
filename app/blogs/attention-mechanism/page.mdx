...
![Self-attention Diagram](/blog-images/attention-mechanism/banner.jpg "Cover")
...
![Encoder Decoder with Attention.png](/blog-images/attention-mechanism/Encoder_Decoder_with_Attention.png)
